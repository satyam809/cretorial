...
const Logout = () => {
    ...
    useEffect(() => {
        ...
        setTimeout(() => {
            ...
            window.location.href = 'https://cretorial.ai';
        }, 100);
    }, [dispatch]);
        ...
        <>
            {/* <AuthLayout bottomLinks={<BottomLink />}>
                <div className="text-center">
                    ...
                    <p className="text-muted mt-2 mb-1">{t('You are now successfully sign out.')}</p>
                    <Row>
                        <Col xs={12} className="text-center mb-2 mt-2">
                            <Link to="/auth/login" className="btn btn-white mb-2 mb-sm-0 me-1">
                                {t('Login')}
                            </Link>                 
                        </Col>
                    </Row>
